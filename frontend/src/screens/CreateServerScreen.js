        ...
        return (
            <Modal show={this.state.showModal} onHide={this.handleModalClose}>
                <form action="#" method="post">
                    ...
                    <Modal.Body>
                        <p style={{ color: "red",margin:0 }} dangerouslySetInnerHTML={{ __html: this.state.error }}></p>
                        <p style={{ color: "green",margin:0 }} dangerouslySetInnerHTML={{ __html: this.state.success }}></p>
                        <div class="col-sm-12 login-form-container">
                            <div class="col-sm-12 modal-form form-group">
                                <label htmlFor="">Server Name</label>
                                <input type="text" required value={this.state.name} onChange={this.dataChange} name="name" className="form-input-field" id="Namemanageserver"
                        ...
                        <div class="col-sm-12 login-form-container">
                            <div class="col-sm-12 modal-form form-group">
                                ...
                                <select required value={this.state.size} onChange={this.dataChange} name="size" className="form-input-field">
                                    {this.renderOptions()}
                                </select>
                                <svg class="input-icon" width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="45" height="45" rx="8" fill="#7973FE"/>
                        ...
                        <div class="col-sm-12 login-form-container">
                            <div class="col-sm-12 modal-form form-group">
                                ...
                                <select id="locations" required value={this.state.location} onChange={this.dataChange} name="location" className="form-input-field">
                        ...
                        <div class="col-sm-12 login-form-container">
                            <div class="col-sm-12 modal-form form-group">
                                ...
                                <input type="text" required  value={this.state.appName} onChange={this.dataChange} name="appName" className="form-input-field" id="appName"
                    ...
                    <Modal.Footer>
                        <div className="col-12 model-form-action">
                            <Button variant="default" onClick={this.handleModalClose}>
                                CLOSE
                            </Button>
                            <button type="button" onClick={this.formAction} className="theme-btn float-right">
                                {this.state.loadding ?
