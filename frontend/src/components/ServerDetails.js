                    ...
                    <div className="card-body">
                        <div className="col-12 application_page_cards" id="huddles">
                            <ul class="nav nav-pills mb-3" id="server-details-tab-header" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-resouces-tab" data-toggle="pill" href="#pills-resouces" role="tab" aria-controls="pills-resouces" aria-selected="false">Server Health</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-cron-tab" data-toggle="pill" href="#pills-cron" role="tab" aria-controls="pills-cron" aria-selected="false">Cron Jobs</a>
                                </li>
                                <li class="nav-item">
